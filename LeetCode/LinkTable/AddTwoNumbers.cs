...
namespace ConsoleTest.LinkTable
{
  ...
  public class ListNode
    ...
    public class AddTwoNumbers
    {
        ...
        public ListNode AddTwoNumbers9(ListNode l1, ListNode l2, int num = 0) 
        { 
            if(l1==null&&l2==null)
            {
                if (num > 0) { return new ListNode(num); }
            ...
            int midValue = l1?.val??0 + l2?.val??0 + num;
            ListNode outlist = new ListNode(midValue%10);

            outlist.next = AddTwoNumbers9(l1?.next, l2?.next, midValue / 10);
        ...
        #endregion
        public ListNode AddTwoNumbers21(ListNode l1, ListNode l2, int num = 0)
        {
            if (l1 == null && l2 == null)
            {
                if (num > 0)
            ...
            int val = l1?.val ?? 0 + l2?.val ?? 0 + num;
            ListNode outs = new ListNode(val % 10);

            outs.next = AddTwoNumbers21(l1?.next, l2?.next, val / 10);
